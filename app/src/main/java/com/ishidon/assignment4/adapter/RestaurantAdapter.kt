package com.ishidon.assignment4.adapter
...
class RestaurantAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    RecyclerView.Adapter<RestaurantAdapter.AllRestaurantsViewHolder>() {
